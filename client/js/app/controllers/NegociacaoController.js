...
System.register(['../models/Negociacao', '../models/Mensagem', '../models/ListaNegociacoes', '../services/NegociacaoService', '../views/NegociacoesView', '../helpers/Bind', '../views/MensagemView', '../helpers/DateHelper'], function (_export, _context) {
    "use strict";

    var Negociacao, Mensagem, ListaNegociacoes, NegociacaoService, NegociacoesView, Bind, MensagemView, DateHelper, _createClass, NegociacaoController, negociacaoController;
        ...
        execute: function () {
            ...
            NegociacaoController = function () {
                function NegociacaoController() {
                    ...
                    this._mensagem = new Bind(new Mensagem(), new MensagemView($('#mesagemView')), 'texto');
